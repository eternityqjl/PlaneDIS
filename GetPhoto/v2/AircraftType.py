...
manufacturer = [Airbus_AircraftType, Antonov_AircraftType, ATR_AircraftType, Boeing_AircraftType, \
                Bombardier_AircraftType, De_Havilland_Canada_AircraftType, British_Aerospace_AircraftType, \
                COMAC_AircraftType, McDonnell_Douglas_AircraftType, Embraer_AircraftType]
